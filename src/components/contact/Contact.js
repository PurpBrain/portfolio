    ...
    return (
        <div id="contact" className="xl:px-[250px] lg:px-[100px] md:px-[50px] px-[20px] py-[50px] relative">
            ...
            <div className="flex gap-x-2 sm:gap-x-5 justify-center">
                <a target="_blank" rel="noreferrer" style={{ "--size": "83.61px" }} className="flex bg-primary gap-x-2.5 py-[10px] pl-[10px] hover:pr-[10px] rounded-lg items-center text-headline" href="https://www.linkedin.com/in/l%C3%A9o-doray-529506203/">
                ...
                <a target="_blank" rel="noreferrer" style={{ "--size": "62.28px" }} className="flex bg-primary gap-x-2.5 py-[10px] pl-[10px] hover:pr-[10px] rounded-lg items-center text-headline" href="https://www.instagram.com/leo_dr72/">
                ...
                <a target="_blank" rel="noreferrer" style={{ "--size": "71.16px" }} className="flex bg-primary gap-x-2.5 py-[10px] pl-[10px] hover:pr-[10px] rounded-lg items-center text-headline" href="https://github.com/PurpBrain">
                ...
                <a target="_blank" rel="noreferrer" style={{ "--size": "154.97px" }} className="flex bg-primary gap-x-2.5 py-[10px] pl-[10px] hover:pr-[10px] rounded-lg items-center text-headline" href="mailto:leo.doray@gmail.com">
