            ...
            <div className="grid md:grid-cols-2 gap-y-8 grid-row-2 md:justify-items-end justify-items-center items-center">
                <div className="text-xl text-text font-Helvetica">
                    ...
                    <p data-aos="fade-up" data-aos-duration="1300" className="py-[30px]">
                        En mai 2022, j'ai obtenu le diplôme de <a className="text-tertiary decoration-0 hover:underline" href="https://arinfo.fr/formations/metiers-du-web/formation-developpeur-web">Développeur Web</a> après avoir suivi la formation auprès <a className="text-tertiary decoration-0 hover:underline" href="https://www.arinfo.fr/">Arinfo</a>.
