...
const Header = () => {
    return (
        <header className="xl:px-[250px] lg:px-[100px] md:px-[50px] pb-[50px] pt-[100px] bg-primary flex sm:flex-cols justify-between">
            ...
            <img className="w-1/3" src={require(`../../assets/image/svg/Illustration-bureau.svg`).default} alt="Svg bureau" />
        </header>
    );
};
